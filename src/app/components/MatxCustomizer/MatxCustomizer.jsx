              ...
              {/* {tabIndex === 1 && (
                <div>
                  <div className="helpText">
                    Portfolio{" "}
                    <Link
                      href="https://react-portfolio-ptd.netlify.app/projects/single-project"
                      target="_blank"
                    >
                      Portfolio
                    </Link>
...
const demoLayouts = [
  ...
  // === NEW: 3 layouts added ===
  {
    ...
    options: {
      ...
      activeLayout: "layout1",
      layout1Settings: {
        topbar: { theme: "whitePurple", fixed: true },
        leftSidebar: { mode: "full", theme: "purple1", bgOpacity: 0.95 }
      },
      footer: { theme: "purple1" }
    }
  },
  {
    isPro: false,
    ...
    options: {
      activeTheme: "blueDark",
      activeLayout: "layout1",
      layout1Settings: {
        topbar: { theme: "blueDark", fixed: true },
        leftSidebar: { mode: "full", theme: "blueDark", bgOpacity: 0.92 }
      },
      footer: { theme: "slateDark2" }
    }
  }
];
