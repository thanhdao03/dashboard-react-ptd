  ...
  useEffect(() => {
    if (isAlive) {
      setMessageList([
        {
          contactId: "friend-id",
          text: "Ê, hôm qua mày fix xong cái bug login chưa?",
          name: "Tuấn",
          avatar: "/assets/images/faces/13.jpg"
        },
        {
          contactId: currentUserId,
          text: "Chưa 😅, bị dính lỗi token refresh.",
          name: "Bạn",
          avatar: "/assets/images/face-1.jpg"
        },
        {
          contactId: "friend-id",
          text: "Ờ, cái đó bên React + Firebase hay bị lắm.",
          name: "Tuấn",
          avatar: "/assets/images/faces/13.jpg"
        },
        {
          contactId: currentUserId,
          text: "Tao đang đọc docs MUI với MatX đây.",
          name: "Bạn",
          avatar: "/assets/images/face-1.jpg"
        },
        {
          contactId: "friend-id",
          text: "Ok, cần gì hỏi tao.",
          name: "Tuấn",
          avatar: "/assets/images/faces/13.jpg"
        }
      ]);
